...
|------|---------|-------------|
| [`references/carbon-forge-slide-system.md`](references/carbon-forge-slide-system.md) | Complete HTML/CSS for all 7 slide templates, component library, wkhtmltoimage-compatible patterns | Every carousel or infographic build |
